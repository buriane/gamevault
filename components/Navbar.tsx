...
export default function Navbar() {
  ...
  return (
    <nav className="sticky top-0 z-50 w-full border-b border-(--border-subtle) bg-(--bg-nav) backdrop-blur-md">
        ...
        <div className="flex items-center gap-2 sm:gap-3 text-sm font-medium">
          ...
          >
            <div className={`relative p-1.5 rounded-lg transition-colors ${
              ...
              {wishlist.length > 0 && (
                <span className="absolute -top-1.5 -right-1.5 flex items-center justify-center w-4 h-4 rounded-full bg-pink-500 text-white text-[9px] font-bold ring-2 ring-pink-500/20">
